...
class DTLZ5I : public DTLZ<_TReal>
{
public:
	...
	DTLZ5I(const size_t nObjectives, const size_t manifold, const size_t distDecisions = 10);
	~DTLZ5I(void);
...
template <typename _TReal>
DTLZ5I<_TReal>::DTLZ5I(const size_t nObjectives, const size_t manifold, const size_t distDecisions)
...
template <typename _TReal>
DTLZ5I<_TReal>::~DTLZ5I(void)
{
}

template <typename _TReal>
size_t DTLZ5I<_TReal>::GetManifold(void) const
{
	return manifold_;
}

template <typename _TReal>
size_t DTLZ5I<_TReal>::_DoEvaluate(TSolution &solution)
{
...
template <typename _TReal>
void DTLZ5I<_TReal>::_Evaluate(const TDecision &decision, std::vector<TReal> &objective)
{
...
template <typename _TReal>
template<class _TArchive> void DTLZ5I<_TReal>::serialize(_TArchive &archive, const unsigned version)
{
