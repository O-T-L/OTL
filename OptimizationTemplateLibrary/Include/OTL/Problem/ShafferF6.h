...
class ShafferF6 : public Problem<_TReal, std::vector<_TReal> >, public otl::utility::WithSpaceBoundary<_TReal>
{
public:
...
ShafferF6<_TReal>::ShafferF6(void)
	: TSuper(1)
	, otl::utility::WithSpaceBoundary<TReal>(TBoundary(2, TMinMax(-100, 100)))
{
}
