...
class MOEA_D : public CoupleCoupleAdapter<otl::optimizer::moea_d::MOEA_D<_TReal, _TDecision, _TRandom> >
{
public:
	typedef _TReal TReal;
	typedef _TDecision TDecision;
	typedef _TRandom TRandom;
	typedef CoupleCoupleAdapter<otl::optimizer::moea_d::MOEA_D<TReal, TDecision, TRandom> > TSuper;
