...
class SMS_EMOA : public otl::optimizer::sms_emoa::SMS_EMOA<_TReal, _TDecision, _TRandom, _TMakeHypervolume>, public otl::crossover::WithTripleCrossover<_TReal, _TDecision>, public otl::mutation::WithMutation<_TReal, _TDecision>
{
public:
