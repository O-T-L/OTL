...
class ParetoBox : public Problem<_TReal, std::vector<_TReal> >, public otl::utility::WithBoundary<_TReal>
{
public:
...
ParetoBox<_TReal>::ParetoBox(void)
	: TSuper(10)
	, otl::utility::WithBoundary<TReal>(TBoundary(2, std::make_pair<TReal, TReal>(-10000, 10000)))
{
}
