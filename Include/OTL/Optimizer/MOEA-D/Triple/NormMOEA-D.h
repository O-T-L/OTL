...
class NormMOEA_D : public TripleAdapter<otl::optimizer::moea_d::NormMOEA_D<_TReal, _TDecision, _TRandom> >
{
public:
	typedef _TReal TReal;
	typedef _TDecision TDecision;
	typedef _TRandom TRandom;
	typedef TripleAdapter<otl::optimizer::moea_d::NormMOEA_D<TReal, TDecision, TRandom> > TSuper;
