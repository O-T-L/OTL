...
class MOEA_D : public XTripleAdapter<otl::optimizer::moea_d::MOEA_D<_TReal, _TDecision, _TRandom> >
{
public:
	typedef _TReal TReal;
	typedef _TDecision TDecision;
	typedef _TRandom TRandom;
	typedef XTripleAdapter<otl::optimizer::moea_d::MOEA_D<TReal, TDecision, TRandom> > TSuper;
