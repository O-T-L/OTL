...
class TripleAdapter : public _TMOEA_D, public otl::crossover::WithTripleCrossover<typename _TMOEA_D::TReal, typename _TMOEA_D::TDecision>, public otl::mutation::WithMutation<typename _TMOEA_D::TReal, typename _TMOEA_D::TDecision>
{
public:
	...
	TripleAdapter(TRandom random, TProblem &problem, const std::vector<TDecision> &initial, TCrossover &crossover, TMutation &mutation, const std::vector<TPoint> &weightVectors, const size_t nNeighbors);
	~TripleAdapter(void);
...
template <typename _TMOEA_D>
TripleAdapter<_TMOEA_D>::TripleAdapter(TRandom random, TProblem &problem, const std::vector<TDecision> &initial, TCrossover &crossover, TMutation &mutation, const std::vector<TPoint> &weightVectors, const size_t nNeighbors)
...
template <typename _TMOEA_D>
TripleAdapter<_TMOEA_D>::~TripleAdapter(void)
{
}

template <typename _TMOEA_D>
void TripleAdapter<_TMOEA_D>::_DoStep(void)
{
