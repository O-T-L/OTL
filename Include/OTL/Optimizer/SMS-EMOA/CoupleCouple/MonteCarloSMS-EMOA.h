...
class MonteCarloSMS_EMOA : public otl::optimizer::sms_emoa::MonteCarloSMS_EMOA<_TReal, _TDecision, _TRandom>, public otl::crossover::WithCoupleCoupleCrossover<_TReal, _TDecision>, public otl::mutation::WithMutation<_TReal, _TDecision>
{
public:
