...
class InversionMutation : public Mutation<_TReal, std::vector<size_t> >, public otl::utility::WithRandom<_TRandom>, public otl::utility::WithProbability<_TReal>
{
public:
...
template <typename _TReal, typename _TRandom>
InversionMutation<_TReal, _TRandom>::InversionMutation(TRandom random, const TReal probability)
...
template <typename _TReal, typename _TRandom>
InversionMutation<_TReal, _TRandom>::~InversionMutation(void)
{
}
...
template <typename _TReal, typename _TRandom>
void InversionMutation<_TReal, _TRandom>::_Mutate(TDecision &decision, const size_t begin, const size_t end)
{
	assert(begin < end);
	std::reverse(decision.begin() + begin, decision.begin() + end);
}
}
}
